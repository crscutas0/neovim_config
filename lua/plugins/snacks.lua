...
return {
  ...
  keys = {
    ...
    { "<leader>fv", function() Snacks.picker.git_files() end, desc = "Find Git Files" },
    ...
    { "<leader>n:", function() Snacks.picker.command_history() end, desc = "Command History" },
    { '<leader>n/', function() Snacks.picker.search_history() end, desc = "Search History" },
    { "<leader>nc", function() Snacks.picker.commands() end, desc = "Commands" },
    { "<leader>nC", function() Snacks.picker.colorschemes() end, desc = "Colorschemes" },
    { "<leader>ng", function() Snacks.picker.diagnostics() end, desc = "Diagnostics" },
